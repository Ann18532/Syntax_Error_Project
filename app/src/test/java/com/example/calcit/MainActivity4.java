...
public class MainActivity4 extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View v){
        switch(v.getId()) {
            case R.id.button26:
                textview2.setText("1");
                textview3.setText("3.281");
                textview4.setText("1.094");
                ...
                break;
            case R.id.button28:
                textview2.setText("0.305");
                textview3.setText("1");
                textview4.setText("0.333");
                abc = 3;
            ...
            case R.id.button29:
                textview2.setText("0.914");
                textview3.setText("3.0");
                textview4.setText("1");
                abc = 4;
        ...
        if(abc==2) {
            switch (v.getId()) {
                ...
                case R.id.button38:
                    ...
                    textview3.setText(c.valueOf(3.281 * Double.parseDouble(c)));
                    textview4.setText(c.valueOf(1.094 * Double.parseDouble(c)));
                    break;
                case R.id.button39:
        ...
        if(abc==3) {
            switch (v.getId()) {
                ...
                case R.id.button38:
                    ...
                    textview2.setText(c.valueOf(0.305 * Double.parseDouble(c)));
                    textview4.setText(c.valueOf(0.333 * Double.parseDouble(c)));
                    break;
                case R.id.button39:
        ...
        if(abc==4) {
            switch (v.getId()) {
                ...
                case R.id.button38:
                    ...
                    textview2.setText(c.valueOf(0.914 * Double.parseDouble(c)));
                    textview3.setText(c.valueOf(3.0 * Double.parseDouble(c)));
                    break;
                case R.id.button39:
