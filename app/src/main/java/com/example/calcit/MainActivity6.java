    ...
    public void onClick(View v){
        switch(v.getId()) {
            ...
            case R.id.button28:
                ...
                break;
            case R.id.button29:
                textview2.setText("0.454");
                textview3.setText("0.000454");
                textview4.setText("1");
                abc = 4;
        ...
        if(abc==2) {
            switch (v.getId()) {
                ...
                case R.id.button38:
                    ...
                    textview4.setText(c.valueOf(2.205 * Double.parseDouble(c)));
                    break;
                case R.id.button39:
        ...
        if(abc==3) {
            switch (v.getId()) {
                ...
                case R.id.button38:
                    ...
                    textview2.setText(c.valueOf(1000 * Double.parseDouble(c)));
                    textview4.setText(c.valueOf(2205 * Double.parseDouble(c)));
                    break;
                case R.id.button39:
        ...
        if(abc==4) {
            switch (v.getId()) {
                ...
                case R.id.button38:
                    ...
                    textview2.setText(c.valueOf(0.454 * Double.parseDouble(c)));
                    textview3.setText(c.valueOf(0.000454 * Double.parseDouble(c)));
                    break;
                case R.id.button39:
