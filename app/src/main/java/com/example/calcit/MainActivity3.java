...
public class MainActivity3 extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View v){
        switch(v.getId()) {
            case R.id.button26:
                textview2.setText("1");
                textview3.setText("4046.856");
                textview4.setText("0.405");
                button26.setBackgroundColor(808080);
                abc= 2;
                ...
                break;
            case R.id.button28:
                textview2.setText("0.000247");
                textview3.setText("1");
                textview4.setText("0.0001");
                abc = 3;
        ...
        if(abc==2) {
            switch (v.getId()) {
                ...
                case R.id.button38:
                    ...
                    textview3.setText(c.valueOf(4046.856 * Double.parseDouble(c)));
                    textview4.setText(c.valueOf(0.405 * Double.parseDouble(c)));
                    break;
                case R.id.button39:
        ...
        if(abc==3) {
            switch (v.getId()) {
                ...
                case R.id.button38:
                    ...
                    textview2.setText(c.valueOf(0.000247 * Double.parseDouble(c)));
                    textview4.setText(c.valueOf(0.0001 * Double.parseDouble(c)));
                    break;
                case R.id.button39:
        ...
        if(abc==4) {
            switch (v.getId()) {
                ...
                case R.id.button38:
                    ...
                    textview2.setText(c.valueOf(2.471 * Double.parseDouble(c)));
                    textview3.setText(c.valueOf(10000 * Double.parseDouble(c)));
                    break;
                case R.id.button39:
